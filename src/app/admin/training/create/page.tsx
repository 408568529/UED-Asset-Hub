...
export default async function CreateTrainingPage({ searchParams }: { searchParams: Promise<{ folderId?: string; returnTo?: string }> }) {
  ...
  return <AdminGuard><AdminPageFrame title="上传培训视频" description="上传或关联现有服务器培训媒体。"><TrainingForm initialFolderName={folder?.name} returnTo={returnTo} /></AdminPageFrame></AdminGuard>;
}
